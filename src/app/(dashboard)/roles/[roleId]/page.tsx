        ...
        <>
          ...
          <div className="minimal-card p-7">
            ...
            <div className="mt-6 border-t border-slate-100 pt-4">
              <div className="text-[10px] font-bold text-slate-400 uppercase tracking-widest font-mono mb-2 flex items-center gap-1.5">
              ...
              <div className="flex flex-wrap gap-2">
                {role.requirements.map((req, idx) => (
                  <span
                    key={idx}
                    className="inline-flex items-center gap-1.5 rounded-lg border border-slate-200 bg-slate-50 px-3 py-1 text-xs font-mono text-slate-700"
                  >
          ...
          <div className="space-y-4">
              ...
              <div className="flex flex-wrap items-center gap-2.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="rounded-xl border border-slate-200 bg-white pl-8 pr-3 py-1.5 text-xs text-slate-900 placeholder:text-slate-400 focus:border-blue-500 focus:outline-hidden focus:ring-1 focus:ring-blue-500 w-48 sm:w-56 transition-colors shadow-2xs"
                  />
                </div>

                {/* Filter Pills */}
                <div className="flex rounded-xl border border-slate-200 bg-white p-1 text-xs font-semibold shadow-2xs">
                  <button
            ...
            {filteredCandidates.length === 0 ? (
              <div className="minimal-card p-12 text-center border-dashed">
                ...
                <h3 className="mt-3 text-base font-bold text-slate-900">No Matching Candidates</h3>
              ...
              <div className="minimal-card overflow-hidden">
                <table className="min-w-full divide-y divide-slate-100 text-left">
                  <thead className="bg-slate-50/80 text-[10px] font-bold text-slate-500 uppercase tracking-widest font-mono">
                    <tr>
                    ...
                    {filteredCandidates.map((c, index) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="px-6 py-4">
                            <div className="flex items-center gap-3">
                              <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-blue-100 text-blue-700 text-xs font-bold shadow-2xs">
                                {getInitials(c.name)}
                              </div>
                              <div>
                          ...
                          <td className="px-6 py-4">
                            <div className="flex items-center justify-between text-[11px] font-mono mb-1">
                              <span className="font-bold text-slate-800">{matchedCount} of {totalReqs}</span>
                              <span className="text-slate-400">{matchPercent}%</span>
                            </div>
                          ...
                          <td className="px-6 py-4 text-right">
                            <Link
                              ...
                              className="inline-flex items-center gap-1.5 rounded-lg border border-slate-200 bg-white px-3.5 py-1.5 text-xs font-bold text-slate-700 hover:border-blue-300 hover:bg-blue-50 hover:text-blue-700 transition-all shadow-2xs"
                            >
